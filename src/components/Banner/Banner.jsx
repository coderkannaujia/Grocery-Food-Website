...
import tamato from "/image/tomato.png"
...
const Banner = () => {
  ...
  {/* bg fruit pg */}
    ...
    sm:bottom-0 sm:left-0 opacity-50 sm:opacity-100  ">
     <img 
      data-aos="fade-right"
     src={leaf} alt="apple" className="max-w-[160px]"    />
    </div>
    ...
    sm:bottom-0 sm:left-0 opacity-50 sm:opacity-100  ">
     <img src={tamato} alt="apple" className="max-w-[280px]"    />
    </div>
    ...
    sm:right-2 lg:right-20 opacity-50 sm:opacity-100 ">
     <img src={lemon} alt="apple" className="max-w-[200px]"    />
    </div>
    ...
    className="absolute top-1/2 -translate-y-1/2 left-1/3 -translate-x-1/2
     opacity-50 sm:opacity-100  ">
    <img src={kiwi} alt="apple" className="max-w-[180px]" />
    </div>
